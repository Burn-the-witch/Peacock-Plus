				...
				Definition: {
					...
					States: {
						Start: {
							ChallengeCompleted: [
								{
									$pushunique: ["CompletedChallenges", "$Value.ChallengeId"]
								},
								{
									Condition: {
										$all: {
				...
				Definition: {
					...
					States: {
						EvadeBlame: {
							Disguise: {
								Condition: {
									$eq: ["$Value", "1fdc259e-b96a-47f2-bbd8-e86e78d6df70"]
								},
								Transition: "Success"
							}
						},
							...
							Kill: {
								Condition: {
									$and: [
										...
										{
											$eq: ["$Value.KillMethodStrict", "accident_electric"]
										},
										{
											$eq: ["$Value.OutfitRepositoryId", "1fdc259e-b96a-47f2-bbd8-e86e78d6df70"]
										}
									]
								},
								Transition: "Success"
							...
							Kill: {
								Condition: {
									$and: [
										...
										{
											$eq: ["$Value.KillItemRepositoryId", "94f52181-b9ec-4363-baef-d53b4e424b74"]
										},
										{
											$eq: ["$Value.OutfitRepositoryId", "1fdc259e-b96a-47f2-bbd8-e86e78d6df70"]
										}
				...
				Definition: {
					...
					States: {
						Start: {
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "FireworkStart"]
								},
						...
						Triggered: {
							Kill: {
								Condition: {
									$and: [
										...
										{
											$eq: ["$Value.SetPieceType", "93f3b249-1a2c-46e0-a575-1136a4d00e58"]
										},
										{
											$eq: ["$Value.OutfitRepositoryId", "1fdc259e-b96a-47f2-bbd8-e86e78d6df70"]
										}
							...
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "FireworkEnd"]
								},
								Transition: "Start"
							}
						}
						...
						Chimney: {
							exit_gate: {
								Condition: {
									$or: [
										{
											$eq: ["$Value.RepositoryId", "b4eaa447-0872-4a88-8b66-572f9eb271a2"]
										},
										{
											$eq: ["$Value.RepositoryId", "713feae1-28fc-402b-a8bd-b7f86fbe1e7d"]
										}
									]
								},
								Transition: "Success"
				...
				Definition: {
					...
					States: {
						Start: {
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "Targets_Mourning"]
								},
									...
									$or: [
										{
											$and: [
												{
													$eq: ["$Value.RepositoryId", "21017f2e-3090-4b41-91b9-1ec4ddd358f9"]
												},
												{
													$eq: [
										...
										},
										{
											$and: [
												{
													$eq: ["$Value.RepositoryId", "a713a8a2-e203-4032-9c4a-1f8eab4c3efa"]
												},
												{
													$eq: [
														"$Value.KillItemRepositoryId",
							...
							Kill: {
								Condition: {
									$and: [
										...
										{
											$eq: ["$Value.KillItemRepositoryId", "c601c095-e1dc-4490-aeae-e8e200dd9ac8"]
										},
										{
											$or: [
												{
							...
							Pacify: [
								{
									...
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.KillItemRepositoryId", "5cc4d1ea-b4fa-4667-ba3a-b6e859f03059"]
											}
										]
									}
								},
				...
				Definition: {
					...
					States: {
						Start: {
							...
							ItemPickedUp: [
								{
									...
									Actions: {
										$pushunique: ["ItemArray", "$Value.RepositoryId"]
									}
								},
								{
									Condition: {
										$eq: ["($.TargetItems).Count", "($.ItemArray).Count"]
									},
									Transition: "Success"
								}
							],
							ItemDropped: {
								Actions: {
									$remove: ["ItemArray", "$Value.RepositoryId"]
								}
							},
							...
							Pacify: [
								{
									...
									Condition: {
										$and: [
											{
												$eq: ["$Value.KillItemRepositoryId", "7aeb740f-3d60-4e49-8d27-15a98067ce9f"]
											},
											{
												$any: {
													"?": {
							...
							Kill: [
								{
									...
									Condition: {
										$and: [
											{
												$eq: ["$Value.KillMethodStrict", "accident_explosion"]
											},
											{
												$any: {
													"?": {
							...
							Kill: [
								{
									...
									Condition: {
										$and: [
											{
												$eq: ["$Value.KillMethodStrict", "accident_drown"]
											},
											{
												$any: {
													"?": {
							...
							Kill: [
								{
									...
									Condition: {
										$and: [
											{
												$eq: ["$Value.KillItemRepositoryId", "12cb6b51-a6dd-4bf5-9653-0ab727820cac"]
											},
											{
												$eq: ["$Value.OutfitRepositoryId", "37352a6b-eb58-4458-a5d6-522dd0508baa"]
											},
											{
												$eq: ["$Value.IsTarget", true]
											},
								...
								},
								{
									...
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.OutfitRepositoryId", "844680e8-ae40-4fec-92b7-69c7619feb82"]
											},
											{
												$eq: ["$Value.IsTarget", true]
											},
								...
								{
									Condition: {
										$eq: ["$.CountRed", "$.CountGreen", "$.GoalGreen", "$.GoalRed"]
									},
									Transition: "Success"
								}
							]
							...
							Kill: {
								Condition: {
									$and: [
										...
										{
											$contains: ["$Value.KillItemCategory", "sniperrifle"]
										}
									]
								},
				...
				Definition: {
					...
					States: {
						Sniper_Position: {
									...
									$or: [
										...
										},
										{
											$and: [
												...
												{
													$eq: ["$Value.SetPieceId", "a84ba351-285a-4f07-8758-2d7640401aad"]
												}
											]
										}
									]
							...
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "47_Not_In_Bell_Tower"]
								},
								Transition: "Start"
							}
						},
						Start: {
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "47_In_Bell_Tower"]
								},
							...
							Kill: [
								{
									...
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.OutfitRepositoryId", "dc4762e0-e58e-4336-a3c1-40646087267a"]
											},
											{
												$not: {
													$any: {
				...
				Definition: {
					...
					States: {
						Start: {
							Disguise: {
								Condition: {
									$eq: ["$Value", "dc4762e0-e58e-4336-a3c1-40646087267a"]
								},
								Transition: "Success"
							},
							Kill: {
								Condition: {
									$eq: ["$Value.RepositoryId", "f5ecade6-1a58-44d1-a457-7688746a988d"]
								},
								Transition: "Failure"
							}
						}
							...
							Kill: [
								{
									Actions: {
										$inc: "Count",
										$pushunique: ["TargetKilled", "$Value.SetPieceType"]
									},
									Condition: {
										$and: [
											{
											...
											{
												$eq: ["$Value.SetPieceType", "$Value.SetPieceType"]
											},
											{
												$not: {
								...
								},
								{
									Actions: {
										$inc: "Count",
										$pushunique: ["TargetKilled", "561a1e95-38c0-46a2-87c1-40e356fe7440"]
									},
									Condition: {
										$and: [
											{
												$not: {
													$any: {
														"?": {
															$eq: ["$.#", "561a1e95-38c0-46a2-87c1-40e356fe7440"]
														},
														in: "$.TargetKilled"
													}
												}
								...
								},
								{
									Actions: {
										$inc: "Count",
										$pushunique: ["TargetKilled", "a30e6e87-1dfd-46ac-a770-1d0c4437e1b1"]
									},
									Condition: {
										$and: [
											{
												$not: {
													$any: {
														"?": {
															$eq: ["$.#", "a30e6e87-1dfd-46ac-a770-1d0c4437e1b1"]
														},
														in: "$.TargetKilled"
													}
												}
							...
							AccidentBodyFound: [
								{
									Actions: {
										$inc: "FoundBodies",
										$pushunique: ["ListBodiesFound", "$Value.DeadBody.RepositoryId"]
									},
									Condition: {
										$and: [
											{
												$any: {
													"?": {
														$eq: ["$.#", "$Value.DeadBody.RepositoryId"]
													},
													in: "$.TargetKilled"
												}
											},
							...
							Kill: [
								{
									...
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.OutfitRepositoryId", "c96f9796-0194-47c6-836c-102473cc6c3c"]
											},
											{
												$eq: ["$Value.KillMethodStrict", "accident_drown"]
											}
							...
							Kill: [
								{
									...
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.KillItemRepositoryId", "1bbf0ed5-0515-4599-a4c9-454ce59cff44"]
											},
											{
												$eq: ["$Value.OutfitRepositoryId", "c96f9796-0194-47c6-836c-102473cc6c3c"]
											}
							...
							Kill: [
								{
									...
									Condition: {
										$and: [
											{
												$eq: ["$Value.KillMethodStrict", "accident_push"]
											},
											{
												$eq: ["$Value.IsTarget", true]
											},
				...
				Definition: {
					...
					States: {
						Check_IsDisguiseBlown: {
							...
							DisguiseBlown: {
								Condition: {
									$eq: ["$Value", "fd5d2b9d-dcef-4596-a98a-5266a148c40c"]
								},
							...
							Kill: [
								{
									...
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.OutfitRepositoryId", "fd5d2b9d-dcef-4596-a98a-5266a148c40c"]
											},
											{
												$any: {
													"?": {
											...
											{
												$eq: ["$Value.KillItemRepositoryId", "369c68f7-cbef-4e45-83c7-8acd0dc2d237"]
											}
										]
									},
									Transition: "ContainSituation"
							...
							Kill: [
								{
									...
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.KillMethodStrict", "injected_poison"]
											}
										]
									},
									Transition: "ContainSituation"
		...
		Challenges: [
			{
				...
				Tags: ["story", "very-hard", "biker-pack", "live"]
			},
			{
				...
				Definition: {
					...
					States: {
						...
						Start: {
							Disguise: {
								Condition: {
									$eq: ["$Value", "8e01f48f-ef06-448c-9d22-5d58c4414968"]
								},
				...
				Tags: ["story", "hard", "biker-pack", "live"]
			},
			{
				...
				Tags: ["story", "medium", "biker-pack", "live"]
			},
			{
				...
				Definition: {
					...
					States: {
						Disguise_On: {
							...
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "Poison_Kill"]
								},
								Transition: "End_Contract"
							}
						},
		...
		Challenges: [
					...
					States: {
						Start: {
							ChallengeCompleted: [
								...
								{
									Condition: {
										$eq: ["($.CompletedChallenges).Count", "($.RequiredChallenges).Count"]
									},
									Transition: "Success"
								}
							]
			...
			},
			{
				...
				Definition: {
					Scope: "session",
					Constants: {
						RequiredWeapons: ["e55eb9a4-e79c-43c7-970b-79e94e7683b7", "5631dace-7f4a-4df8-8e97-b47373b815ff"],
					...
					States: {
						Start: {
							Kill: [
								...
								{
									Condition: {
										$eq: ["$.KilledTargetCount", "$.RequiredTargetCount"]
									},
									Transition: "Success"
								}
							]
							...
							Kill: [
								{
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.KillItemRepositoryId", "5631dace-7f4a-4df8-8e97-b47373b815ff"]
											},
											{
												$eq: ["$Value.OutfitIsHitmanSuit", true]
											}
				...
				Definition: {
					...
					States: {
						Start: {
							setpieces: {
								Condition: {
									$eq: ["$Value.name_metricvalue", "ActorPacifiedByAquarium"]
								},
								Transition: "Success"
							}
						}
							...
							Kill: [
								{
									Condition: {
										$and: [
											{
												$eq: ["$Value.KillItemRepositoryId", "901a3b51-51a0-4236-bdf2-23d20696b358"]
											},
											{
												$any: {
													"?": {
								...
								{
									Condition: {
										$eq: ["$.GuardsEliminated", "$.GuardsRequired"]
									},
									Transition: "Success"
								}
							],
							...
							Kill: [
								{
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.KillItemRepositoryId", "6ecf1f15-453c-4783-9c70-8777c83934d7"]
											}
										]
									},
									Transition: "Success"
		...
		Challenges: [
					...
					States: {
						Start: {
							FishSavedEvent: [
								...
								{
									Condition: {
										$ge: ["$.CurrentFishCount", "$.RequiredFishCount"]
									},
									Transition: "Success"
								}
							]
			...
			},
			{
				...
				Definition: {
					Scope: "session",
					Constants: {
						RequiredTargets: ["36b85be9-4c56-491a-8413-4d3292b596e9", "ab2f84f7-5429-4c3a-9726-b770f9d693ee"]
					},
					Context: {
						KilledTargets: []
					},
							...
							Kill: [
								{
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.SetPieceId", "b91b6766-233c-43c0-96dc-d64a588207fd"]
											}
										]
									},
									$pushunique: ["KilledTargets", "$Value.RepositoryId"]
								},
								{
									Condition: {
										$eq: ["($.KilledTargets).Count", "($.RequiredTargets).Count"]
									},
									Transition: "Success"
								},
								{
							...
							Kill: [
								{
									Condition: {
										$and: [
											{
												$eq: ["$Value.RepositoryId", "f3e796af-bc6f-41db-8694-1424235250e7"]
											},
											{
												$eq: ["$Value.SetPieceId", "f39a1df6-b57c-4020-9dad-5df2f411e6f5"]
											}
										]
									},
									Transition: "Success"
			...
			},
			{
				...
				Definition: {
					Scope: "session",
					Constants: {
						RequiredTargets: ["ee454990-0c4b-49e5-9572-a67887325283", "c0ab162c-1502-40d5-801f-c5471289d6b7"]
					},
					Context: {
						PacifiedTargets: []
					},
				...
				Definition: {
					...
					States: {
						...
						CorrectOutfit: {
							ItemPickedUp: {
								Condition: {
									$eq: ["$Value.RepositoryId", "78adb05a-9593-4575-ac39-e4defb78d4ce"]
								},
								Transition: "Success"
							},
							Disguise: [
					...
					States: {
						Start: {
							SugarEvent: [
								...
								{
									Condition: {
										$ge: ["$.CurrentSugarCount", "$.RequiredSugarCount"]
									},
									Transition: "Success"
								}
							]
							...
							Pacify: [
								{
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.KillItemRepositoryId", "74b04d1f-8ac9-46a0-9a6c-8579cf03276f"]
											}
										]
									},
									Transition: "Success"
				...
				Definition: {
					...
					States: {
						Start: {
							setpieces: {
								Condition: {
									$eq: ["$Value.RepositoryId", "58c3b7bc-8d89-48f8-927a-d9b4b7fdd8e4"]
								},
								Transition: "Shredder"
							}
						},
				...
				Definition: {
					...
					States: {
						Start: {
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "C_ShamanFibreWire_Ruins"]
								},
								Transition: "Success"
							}
						}
							...
							Kill: [
								{
									...
									Condition: {
										$and: [
											{
												$eq: ["$Value.OutfitRepositoryId", "30005896-2b39-49c0-bb04-3475d4a12ae6"]
											},
											{
												$eq: ["$Value.KillClass", "poison"]
											}
				...
				Definition: {
					...
					States: {
						Start: {
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "C_Bass_Dropped"]
								},
								Transition: "Success"
							}
						}
				...
				Definition: {
					...
					States: {
						Start: {
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "C_BandPractice"]
								},
								Transition: "Success"
							}
						}
				...
				Definition: {
					...
					States: {
						Start: {
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "C_Cello_Played"]
								},
								Transition: "Success"
							}
						}
				...
				Definition: {
					...
					States: {
						Start: {
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "C_PostGig_Drinks"]
								},
								Transition: "Success"
							}
						}
		...
		Challenges: [
			{
				...
				Definition: {
					Scope: "profile",
					Constants: {
						RequiredChallenges: ["22474e66-dc60-40eb-938d-402bd153b4e6", "63955a0c-242c-423e-afef-66e9bc81bed0"]
					},
					Context: {
						CompletedChallenges: []
					},
							...
							Pacify: [
								{
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.KillItemRepositoryId", "ac77e98d-4ffa-4755-80fc-cd6e7adc63fb"]
											}
										]
									},
									Transition: "Success"
		...
		Challenges: [
				...
				Definition: {
					...
					States: {
						Start: {
							...
							Kill: {
								Condition: {
									$eq: ["$Value.RepositoryId", "856b2aa2-e224-48c3-b890-01fdf4dba6de"]
								},
								Transition: "Failure"
							}
						}
					...
					States: {
						Start: {
							ContractStart: [
								{
									Condition: {
										$eq: ["$Value.Disguise", "$.RequiredOutfit"]
									},
									Transition: "CorrectOutfit"
								}
							],
				...
				Definition: {
					...
					States: {
						...
						CorrectOutfit: {
							setpieces: {
								Condition: {
									$eq: ["$Value.RepositoryId", "2b01e2d0-f302-4b8a-822b-867ba9728f76"]
								},
					...
					States: {
						Start: {
							Pacify: [
								{
									Condition: {
										$eq: ["$Value.KillItemRepositoryId", "5952b621-fee9-4699-809c-8889abadfdb8"]
									},
									Actions: {
										$inc: "PeopleKnocked"
									}
			...
			},
			{
				...
				Definition: {
					...
					Constants: {
						RequiredOutfit: "5d19c9f8-7df2-4113-b81d-b32d5e231717",
						Targets: ["a5be536f-8cc1-444a-abe1-a3f0d7cf8ecd", "a6aa8b8f-24d3-44b7-ba89-063c251d4881"],
						Goal: 2
					},
					Context: {
						Count: 0
					...
					States: {
						Start: {
							setpieces: {
								Condition: {
									$eq: ["$Value.RepositoryId", "57d69808-1233-4aa6-9bda-c38fe0122c80"]
								},
							...
							Kill: [
								{
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.OutfitRepositoryId", "5d19c9f8-7df2-4113-b81d-b32d5e231717"]
											}
										]
									},
									Actions: {
		...
		Challenges: [
				...
				Definition: {
					...
					States: {
						Start: {
							Pacify: [
								{
									...
									Actions: {
										$pushunique: ["PacifiedCops", "$Value.RepositoryId"]
									}
								},
								{
									Condition: {
										$eq: ["($.PacifiedCops).Count", "$.RequiredCops"]
									},
									Transition: "Success"
								}
							],
							BodyFound: {
								Actions: {
									$remove: ["PacifiedCops", "$Value.DeadBody.RepositoryId"]
								}
							}
						}
					}
			...
			},
			{
				...
				Definition: {
					Scope: "session",
					Constants: {
						RequiredDoors: ["Cassidy", "Janus", "Schmidt", "West"]
					},
					Context: {
						BrokenUpDoors: []
					},
							...
							FrontDoorBrokenOpen: [
								{
									...
									$pushunique: ["BrokenUpDoors", "$Value"]
								},
								{
									Condition: {
										$eq: ["($.BrokenUpDoors).Count", "($.RequiredDoors).Count"]
									},
									Transition: "Success"
								}
							]
				...
				Definition: {
					...
					States: {
						Start: {
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "C_CannonFired"]
								},
								Transition: "Success"
							}
						}
							...
							Kill: [
								{
									...
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.OutfitRepositoryId", "d40fe7e8-ec8d-429b-a86b-7844c0e4d1c7"]
											},
											{
												$eq: ["$Value.KillItemCategory", "assaultrifle"]
											}
										]
									}
								},
							...
							Pacify: [
								{
									...
									Condition: {
										$and: [
											{
												$eq: ["$Value.OutfitRepositoryId", "e9a9b20d-93de-48b7-8840-73411bace252"]
											},
											{
												$eq: ["$Value.KillItemRepositoryId", "7aeb740f-3d60-4e49-8d27-15a98067ce9f"]
											}
				...
				Definition: {
					...
					States: {
						Start: {
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "C_Dagger_Butler"]
								},
								Transition: "Success"
							}
						}
							...
							Pacify: [
								{
									...
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.KillItemRepositoryId", "b86b9ece-c929-44f6-8903-8f2c817e2a19"]
											}
										]
									}
								},
				...
				Definition: {
					...
					States: {
						Start: {
							Level_Setup_Events: {
								Condition: {
									$eq: ["$Value.Event_metricvalue", "C_IronMaidenButler"]
								},
								Transition: "Success"
							}
						}
							...
							Pacify: [
								{
									Condition: {
										$and: [
											...
											{
												$not: {
													$eq: ["$Value.KillItemCategory", "case"]
												}
											}
										]
									},
									Actions: {
										$remove: ["PacifiedByCase", "$Value.RepositoryId"]
									}
								},
								{
									Condition: {
									...
									Actions: {
										$pushunique: ["PacifiedByCase", "$Value.RepositoryId"]
									}
								}
							],
							BodyHidden: [
						...
						Start: {
							...
							Kill: {
								Condition: {
									$and: [
										{
											$eq: ["$Value.IsTarget", "$.HitmanOnHelipad", "$.BriefcaseOnHelipad", true]
										},
										{
											$eq: ["$Value.KillItemCategory", "sniperrifle"]
										}
							...
							ItemPickedUp: [
								{
									...
									Actions: {
										$set: ["MorgueBriefcase", "$Value.RepositoryId"]
									}
								},
								{
									Condition: {
								...
								},
								{
									Condition: {
										$and: [
											...
											{
												$eq: ["$Value.RepositoryId", "$.MorgueBriefcase"]
											}
										]
									},
									Actions: {
							...
							InCryptWithBriefcase_Event: {
								Condition: {
									$and: [
										{
											$not: {
												$eq: ["$.MorgueBriefcase", "00000000-0000-0000-0000-000000000000"]
											}
										},
										{
											$eq: ["$.HasMorgueBriefcase", "$.DressedInBurialRobe", true]
										}
									]
								},
								Transition: "Success"
						...
						ActiveState: {
							...
							Kill: {
								Condition: {
									$and: [
										{
											$eq: ["$Value.RepositoryId", "67f39ab8-c25f-48c3-84be-0ec495a553ec"]
										},
										{
...
module.exports = function LegacyChallengePacks(controller) {
				...
				Start: {
					Kill: {
						Condition: {
							$and: [
								{
									$eq: ["$Value.RepositoryId", "252428ca-3f8e-4477-b2b9-58f18cff3e44"]
								},
								{
									$eq: ["$Value.KillItemCategory", "sniperrifle"]
								},
	...
	controller.challengeService.registerChallenge(EDGYSNIPER, "feats", EDGYSNIPER.ParentLocationId, "h3")
	...
	parisexistingMasteryData.Drops = parisexistingMasteryData.Drops.filter(
		(drop) => drop.Id !== "PROP_MELEE_SYRINGE_SEDATIVE"
	)
	...
	BKexistingMasteryData.Drops = BKexistingMasteryData.Drops.filter(
		(drop) => drop.Id !== "PROP_MELEE_ANTIQUE_SYRINGE_LETHAL"
	)
	...
	MBbexistingMasteryData.Drops = MBbexistingMasteryData.Drops.filter(
		(drop) => drop.Id !== "PROP_MELEE_ANTIQUE_KNIFE_CURVED"
	)
	...
	SGbexistingMasteryData.Drops = SGbexistingMasteryData.Drops.filter(
		(drop) => drop.Id !== "PROP_CONTAINER_SUITCASE_SLOW_MK_II"
	)
	...
	for (const group of groups) {
		...
		for (const challenge of group.Challenges) {
			...
			controller.challengeService.registerChallenge(challenge, group.CategoryId, challenge.ParentLocationId, "h3")
		}
							...
							Condition: {
								$and: [
									...
									},
									{
										$or: [
											{
												$eq: ["$Value.KillItemRepositoryId", "3c24c96a-557c-472a-9d71-1a235d7383a7"]
											},
											{
												$eq: ["$Value.KillItemRepositoryId", "c4747fa2-4958-4a02-926e-3b069cf218dc"]
											}
										]
									}
								]
