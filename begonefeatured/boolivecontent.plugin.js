                        ...
                        "Condition": {
                            "$and": [
                                ...
                                },
                                {
                                    "$eq": [
                                        "$Value.SetPieceType",
                                        "9d730373-d18b-46d5-9250-32d07560c2ea"
                                    ]
                                },
                                {
                                    "$eq": [
                    ...
                    "Condition": {
                        "$and": [
                            ...
                            },
                            {
                                "$eq": [
                                    "$Value.RepositoryId",
                                    "93767116-a765-4e97-b51c-c45879457e71"
                                ]
                            }
                        ]
                    },
...
controller.challengeService.registerChallenge(
    sapiboatexit1,
    "discovery",
    sapiboatexit1.ParentLocationId,
    "h3"
)
let sapiboatexit2 = {
...
controller.challengeService.registerChallenge(
    sapiboatexit2,
    "discovery",
    sapiboatexit2.ParentLocationId,
    "h3"
)
let sapicarexit = {
...
controller.challengeService.registerChallenge(
    sapiseaplaneexit,
    "discovery",
    sapiseaplaneexit.ParentLocationId,
    "h3"
)
let mambagateexit = {
...
controller.challengeService.registerChallenge(
    mambagateexit,
    "discovery",
    mambagateexit.ParentLocationId,
    "h3"
)
...
controller.challengeService.registerChallenge(
    sapikitchenspawn,
    "discovery",
    sapikitchenspawn.ParentLocationId,
    "h3"
)
let sapiruinsspawn =  {
...
controller.challengeService.registerChallenge(
    sapiruinsspawn,
    "discovery",
    sapiruinsspawn.ParentLocationId,
    "h3"
)
...
controller.challengeService.registerChallenge(
    sapiharbourspawn,
    "discovery",
    sapiharbourspawn.ParentLocationId,
    "h3"
)
let sapiICAspawn = {
...
controller.challengeService.registerChallenge(
    sapibiolabspawn,
    "discovery",
    sapibiolabspawn.ParentLocationId,
    "h3"
)
...
controller.challengeService.registerChallenge(
    sapimorguespawn,
    "discovery",
    sapimorguespawn.ParentLocationId,
    "h3"
)
                ...
                "HeroSpawn_Location": [
                    {
                        "Condition": {
                            "$eq": [
                                "$Value.RepositoryId",
                                "80b8188c-1783-413a-aff6-516c0ab27ffc"
                            ]
                        },
                        "Transition": "Success"
                    },
                ...
                "HeroSpawn_Location": [
                    {
                        "Condition": {
                            "$eq": [
                                "$Value.RepositoryId",
                                "f8aeef13-b522-4351-bc80-810159e629af"
                            ]
                        },
                        "Transition": "Success"
                    },
                ...
                "HeroSpawn_Location": [
                    {
                        "Condition": {
                            "$eq": [
                                "$Value.RepositoryId",
                                "035838e6-a288-4d1a-a1ae-fba484a7c545"
                            ]
                        },
                        "Transition": "Success"
                    },
...
let kingofthecastle = {
    ...
    controller.challengeService.registerChallenge(
        kingofthecastle,
        "assassination",
        kingofthecastle.ParentLocationId,
        "h3"
    );
    let stingraycameras = {
    ...
    controller.challengeService.registerChallenge(
        stingraycameras,
        "discovery",
        stingraycameras.ParentLocationId,
        "h3"
    );
...
controller.challengeService.registerChallenge(
            ...
            controller.challengeService.registerChallenge(
                shahchallenge,
                "assassination",
                shahchallenge.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                sebastianchallenge,
                "feats",
                sebastianchallenge.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
            ...
            controller.challengeService.registerChallenge(
                gasgrenadechallenge,
                "feats",
                gasgrenadechallenge.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                hotsummerchallenge,
                "feats",
                hotsummerchallenge.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                okaystephenking,
                "feats",
                okaystephenking.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
            ...
            controller.challengeService.registerChallenge(
                actualtorture,
                "assassination",
                actualtorture.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                parisbasement,
                "discovery",
                parisbasement.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                parischopper,
            ...
            controller.challengeService.registerChallenge(
                parislockerspawn,
                "discovery",
                parislockerspawn.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                parisauctionspawn,
                "discovery",
                parisauctionspawn.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                parisdressingspawn,
                "discovery",
                parisdressingspawn.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                parisavspawn,
                "discovery",
                parisavspawn.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                parisbargespawn,
                "discovery",
                parisbargespawn.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
            ...
            controller.challengeService.registerChallenge(
                parisatticspawn,
                "discovery",
                parisatticspawn.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                pariskitchenspawn,
                "discovery",
                pariskitchenspawn.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
            ...
            controller.challengeService.registerChallenge(
                sureican,
                "feats",
                sureican.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                lit,
                "feats",
                lit.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                homerun,
                "feats",
                homerun.ParentLocationId,
                "h3"
            )
            let    stonesniper1 = {
          ...
          let  stonesniper3 = {
            ...
            controller.challengeService.registerChallenge(
                boscochallenge,
                "targets",
                boscochallenge.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                politicianchallenge,
                "targets",
                politicianchallenge.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                cashmerianchallenge,
                "feats",
                cashmerianchallenge.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                casechallenge,
                "feats",
                casechallenge.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                phonechal,
                "feats",
                phonechal.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                sparkymarakech,
                "feats",
                sparkymarakech.ParentLocationId,
                "h3"
            )
            controller.challengeService.registerChallenge(
                axechallenge,
                "feats",
                axechallenge.ParentLocationId,
                "h3"
            )
            const SapienzaexistingMasteryData = controller.masteryService.getMasteryPackage("LOCATION_PARENT_COASTALTOWN", "h3");
            SapienzaexistingMasteryData.Drops.splice(SapienzaexistingMasteryData.Drops.length - 1, 0,{ Id: "PROP_DEVICE_ICA_RUBBERDUCK_PROXIMITY_EXPLOSIVE", Level: 20 });
            SapienzaexistingMasteryData.Drops = SapienzaexistingMasteryData.Drops.filter(drop => drop.Id !== "PROP_DISTRACTION_FIRECRACKER");
            controller.masteryService.registerMasteryData(SapienzaexistingMasteryData)
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_GREEDY", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_GREEDY", "h3").Drops.length - 8, 0,{ Id: "PROP_MELEE_PHONE_CORD", Level: 9 });
            controller.masteryService.registerMasteryData(controller.masteryService.getMasteryPackage("LOCATION_PARENT_GREEDY", "h3"))
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_NORTHAMERICA", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_NORTHAMERICA", "h3").Drops.length - 5, 0,{ Id: "FIREARMS_PISTOL_DARTGUN_SEDATIVE", Level: 16 });
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_NORTHAMERICA", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_NORTHAMERICA", "h3").Drops.length - 1, 0,{ Id: "FIREARMS_SMG_RUDE_RUBY", Level: 20 });
            controller.masteryService.registerMasteryData(controller.masteryService.getMasteryPackage("LOCATION_PARENT_NORTHAMERICA", "h3"))
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_NORTHSEA", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_NORTHSEA", "h3").Drops.length - 9, 0,{ Id: "PROP_DEVICE_REMOTE_CONCUSSION", Level: 13 });
            controller.masteryService.registerMasteryData(controller.masteryService.getMasteryPackage("LOCATION_PARENT_NORTHSEA", "h3"))
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_NEWZEALAND", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_NEWZEALAND", "h3").Drops.length - 4, 0,{ Id: "PROP_DEVICE_ICA_TRIPWIRE_EXPLOSIVE", Level: 3 });
            controller.masteryService.registerMasteryData(controller.masteryService.getMasteryPackage("LOCATION_PARENT_NEWZEALAND", "h3"))
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_MIAMI", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_MIAMI", "h3").Drops.length - 6, 0,{ Id: "PROP_DEVICE_ICA_MICRO_REMOTE_EXPLOSIVE", Level: 17 });
            controller.masteryService.registerMasteryData(controller.masteryService.getMasteryPackage("LOCATION_PARENT_MIAMI", "h3"))
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_ELEGANT", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_ELEGANT", "h3").Drops.length - 4, 0,{ Id: "FIREARMS_HERO_SHOTGUN_SILENCED", Level: 17 });
            controller.masteryService.registerMasteryData(controller.masteryService.getMasteryPackage("LOCATION_PARENT_ELEGANT", "h3"))
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_ANCESTRAL", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_ANCESTRAL", "h3").Drops.length - 14, 0,{ Id: "PROP_DEVICE_ICA_MODULAR_BREACHCHARGE_S3", Level: 9 });
            controller.masteryService.registerMasteryData(controller.masteryService.getMasteryPackage("LOCATION_PARENT_ANCESTRAL", "h3"))
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_HOKKAIDO", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_HOKKAIDO", "h3").Drops.length - 10, 0,{ Id: "FIREARMS_HERO_SMG_TACTICAL_012_ST_AIM_SU_SKIN03", Level: 14 });
            controller.masteryService.registerMasteryData(controller.masteryService.getMasteryPackage("LOCATION_PARENT_HOKKAIDO", "h3"))
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_ROCKY", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_ROCKY", "h3").Drops.length - 10, 0,{ Id: "FIREARMS_HERO_PISTOL_TACTICAL_ICA_19_FA_STEALTH_DUCKY", Level: 11 });
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_ROCKY", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_ROCKY", "h3").Drops.length - 1, 0,{ Id: "FIREARMS_SNIPER_ICA_HACKL_LEVIATHAN_COVERT_DUCKY", Level: 20 });
            controller.masteryService.registerMasteryData(controller.masteryService.getMasteryPackage("LOCATION_PARENT_ROCKY", "h3"))
            controller.masteryService.getMasteryPackage("LOCATION_PARENT_COLOMBIA", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_COLOMBIA", "h3").Drops.length - 13, 0,{ Id: "PROP_DEVICE_ICA_MODULAR_REMOTE_BREACHCHARGE_S2", Level: 12 });
            if (!controller.smf.modIsInstalled("anthonyfuller.phonegobuzz")) {}
                ...
                controller.masteryService.getMasteryPackage("LOCATION_PARENT_GREEDY", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_GREEDY", "h3").Drops.length - 1, 0,{ Id: "PROP_DEVICE_ICA_REMOTE_ELECTRICUTION_PHONE", Level: 19 });
            controller.masteryService.registerMasteryData(controller.masteryService.getMasteryPackage("LOCATION_PARENT_GREEDY", "h3"))}
        controller.masteryService.getMasteryPackage("LOCATION_PARENT_WET", "h3").Drops.splice(controller.masteryService.getMasteryPackage("LOCATION_PARENT_WET", "h3").Drops.length - 5, 0,{ Id: "PROP_DEVICE_ICA_SEMTEX_REMOTE_EXPLOSIVE_S3", Level: 17 });
        ...
        let MasterAssassinChallengePack= [
            {
                ...
                ImageName:
                    "images/challenges/profile_challenges/escalation_s2_tier_1.jpg",
            ...
            },
            {
                ...
                ImageName:
                    "images/challenges/profile_challenges/escalation_s2_tier_2.jpg",
        ...
        States: {
          "Start": {
            ...
            },
            {
                ...
                ImageName:
                    "images/challenges/profile_challenges/escalation_s2_tier_3.jpg",
        ...
        States: {
          "Start": {
            ...
            },
            {
                ...
                ImageName:
                    "images/challenges/profile_challenges/escalation_s2_tier_4.jpg",
        ...
        States: {
          "Start": {
            ...
            },
            {
                ...
                ImageName:
                    "images/challenges/profile_challenges/escalation_s2_tier_5.jpg",
        ...
        States: {
          "Start": {
            ...
            },
            {
                ...
                ImageName:
                    "images/challenges/profile_challenges/escalation_s2_tier_6.jpg",
        ...
        States: {
          "Start": {
            ...
            },
            {
                ...
                ImageName:
                    "images/challenges/profile_challenges/escalation_s2_tier_7.jpg",
        ...
        States: {
          "Start": {
            ...
            },
            {
                ...
                ImageName:
                    "images/challenges/profile_challenges/escalation_s2_tier_8.jpg",
        ...
        States: {
          "Start": {
            ...
            },
            {
                ...
                ImageName:
                    "images/challenges/profile_challenges/escalation_s2_tier_9.jpg",
        ...
        States: {
          "Start": {
            ...
            },
            {
                ...
                ImageName:
                    "images/challenges/profile_challenges/escalation_s2_tier_10.jpg",
